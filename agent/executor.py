...
def _call_tool(tool: str, parameters: dict, speak: Callable | None) -> str:
    ...
    elif tool == "social_media_creator":
        from actions.social_media_creator import social_media_creator
        return social_media_creator(parameters=parameters, player=None, speak=speak) or "Done."

    elif tool == "social_media_manager":
        from actions.social_media_creator import social_media_manager
        return social_media_manager(parameters=parameters, player=None, speak=speak) or "Done."
